...
describe "BeermappingApi" do
	...
	describe "in case of cache miss" do
		...
		it "returns parsed result when HTTP GET returns one entry" do
		...
		it "returns parsed result when HTTP GET returns multiple entries" do
			...
			expect(names.size).to eq(9)
			expect(names).to include('Kaisla')
			expect(names).to include('Pikkulintu')
			expect(names). to include('Suomenlinnan Panimo')
		end
	end

	describe "in case of cache hit" do

		it "returns parsed result when one entry in cache" do
		...
		it "returns parsed result when multiple entries in cache" do
